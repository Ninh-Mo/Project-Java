...
<head>
    ...
    <link rel="stylesheet" href="../resources/css/admin/messageManage.css">
...
<div class="admin_content_wrap">
        ...
        <c:if test="${listCheck != 'empty' }">
            <table class="author_table">
                ...
                <tr>
                    ...
                    <td class="th_column_7">category</td>
                    <td class="th_column_8">Skin Name</td>
                    <td class="th_column_9">Display Flag</td>
                    <td class="th_column_20">Create Date</td>
                    <td class="th_column_21">Edit Date</td>
                </tr>
                </thead>
    ...
    <div class="search_wrap">
        <form id="searchForm" action="/admin/messageManage" method="get">
    ...
    <form id="moveForm" action="/admin/messageManage" method="get">
...
<script>
    $(document).ready(function(){
        ...
        function checkResult(result){
            ...
            alert("メッセージ'${enroll_result}'追加しました。.");
